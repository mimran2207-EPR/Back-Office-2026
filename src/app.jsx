// epr/app.jsx — router + shell with hash-based routing
...
function parseHash() {
  ...
  // settings/general → page='settings', sub='general'
...
ReactDOM.createRoot(document.getElementById('root')).render(<EprApp/>);
